<script lang="ts">
	...
	import { HomeIcon, CopyIcon, UsersIcon, UserIcon, UserPlusIcon, GiftIcon, PaperclipIcon, ServerIcon, CpuIcon, MonitorIcon, ImageIcon, DollarSignIcon, BookOpenIcon, EyeIcon, PlusCircleIcon, EditIcon, FilePlusIcon, RefreshCcwIcon, UploadCloudIcon, CheckSquareIcon, TagIcon, SunriseIcon, FlagIcon, StarIcon, BookIcon, PhoneIcon, ActivityIcon, TabletIcon, ChevronDownIcon, ChevronRightIcon, MessageSquareIcon } from "svelte-feather-icons";
	...
	let categories = {
		...
		global: JSON.parse(sessionStorage.getItem("nav-global") || false),
	};
		...
		<div class="position-sticky pt-3">
			...
			<ul class="nav flex-column">
				...
				<li class="nav-item mt-2 d-md-none d-block">
					<a class="nav-link" href="/home">Back to Kornet</a>
				</li>
			</ul>
		</div>
	</nav>
