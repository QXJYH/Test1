...
[Route("/")]
public class Catalogandroid : ControllerBase
{
    [HttpGetBypass("v1/categories")]
    ...
    [HttpGetBypass("v1/subcategories")]
    ...
    [HttpGetBypass("v1/catalog/metadata")]
    ...
    [HttpGetBypass("v1/favorites/users/{userId:long}/assets/{assetId:long}/favorite")]
    ...
    [HttpPostBypass("v1/favorites/users/{userId:long}/assets/{assetId:long}/favorite")]
    ...
    [HttpGetBypass("v1/asset-to-category")]
    ...
    [HttpGetBypass("v1/asset-to-subcategory")]
