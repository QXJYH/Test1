...
/**
 * SmallGameCard
 * @param {{name: string; playerCount: number; likes: number; dislikes: number; creatorId: number; creatorType: string | number; creatorName: string; iconUrl: string; placeId: number; className?: string; hideVoting?: boolean; year?: number}} props
 * @returns 
 */
      ...
      <Link href={url}>
        <a>
          <div className={s.imageWrapper}>
            ...
            {props.year && <span className={s.labelYear}>{props.year}</span>}
          </div>
        </a>
      </Link>
